...
describe("popup", () => {
  ...
  it("shows a clear startup error when the active form response is malformed", async () => {
    vi.stubGlobal("chrome", {
      storage: {
        local: {
          get(keys: string[], callback: (result: Record<string, unknown>) => void) {
  ...
  it("shows a clear startup error when active form fields use inherited properties", async () => {
  ...
  it("shows a clear startup error when active form field options are malformed", async () => {
    vi.stubGlobal("chrome", {
      storage: {
        local: {
          get(keys: string[], callback: (result: Record<string, unknown>) => void) {
  ...
  it("shows a clear startup error when active form option-backed fields are missing options", async () => {
    vi.stubGlobal("chrome", {
      storage: {
        local: {
          get(keys: string[], callback: (result: Record<string, unknown>) => void) {
  ...
  it("shows a clear startup error when active form option-backed fields have sparse options", async () => {
  ...
  it("shows a clear startup error when active form non-choice fields have other-option metadata", async () => {
    vi.stubGlobal("chrome", {
      storage: {
        local: {
          get(keys: string[], callback: (result: Record<string, unknown>) => void) {
